# withdrawn designs frozen protocol — M5/M8/M9
...
- Runtime: `python3`
- Seed: `20260815`
- Allowed writes: only the paths named in `analysis_specification.md`.
...
| Source | SHA-256 |
|---|---|
| `analysis_specification.md` | `d03800cea9c8be5552e14bff3bb14953cbc299e81628b4eb68db75c58d0c926b` |
...
The phrase “residence-time correlations” in the analysis specification conflicts with
reviewer R2-M08a/b and the named n=142 proxy panel. The primary M8 question is
...
- branch reports plus `withdrawn_designs_report.md`, including unfavorable results.
