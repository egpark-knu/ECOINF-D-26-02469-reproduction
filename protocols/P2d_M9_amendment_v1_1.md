# P2d M9 protocol amendment v1.1 — exact source duplicates
...
- Base protocol immutable copy: `P2d_freeze_v1_preanalysis.md`

## Trigger and decision chronology

The first P2d run halted M9 at the frozen unique-key gate before any M9 model was
