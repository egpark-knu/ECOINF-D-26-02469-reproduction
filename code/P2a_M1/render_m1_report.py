#!/usr/bin/env python3
"""Render the P2a reconciliation report from independently verified artifacts."""
...
def render(run_root: Path, output: Path) -> None:
    ...
    lines = [
        "# M1 Residence-Time Reconciliation — P2a",
        "",
    ...
    lines.extend([
        ...
        f"- ASK_USER_FIRST(D1): **{'yes' if d1_trigger else 'no'}**. P2a does not make the author-owned manuscript decision.",
        "",
