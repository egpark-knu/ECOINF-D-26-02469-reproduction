"""Single-command fresh matchups v4 builder.
...
EXPECTED_HASHES = {
    "v4_specification": "46ff6f8f3f8239e6f711b2e93a1d07b916499542dff2eabb4bbd3d6f64b9084f",
    "v3_design_specification": "440a99a55a37fa80551c51fce638499ae180145266ab559497d9188dd2a76434",
...
def source_paths() -> dict[str, tuple[str, Path]]:
    ...
    source_root = Path(os.environ.get("MATCHUPS_SOURCE_ROOT", str(public_root / "raw")))
    revision = Path(os.environ.get("MATCHUPS_REVISION_ROOT", str(source_root / "revision")))
    spec_root = Path(os.environ.get("MATCHUPS_SPEC_ROOT", str(source_root / "specifications")))
    auxiliary = Path(os.environ.get("MATCHUPS_AUXILIARY_ROOT", str(source_root / "auxiliary")))
    hab = source_root
    return {
        "v4_specification": ("source_packet/P2c_v4_fresh_implementation_packet.md", spec_root / "P2c_v4_fresh_implementation_packet.md"),
        "v3_design_specification": ("source_packet/P2c_v3_execution_packet.md", spec_root / "P2c_v3_execution_packet.md"),
        "debate": ("source_packet/P2c_stuck_debate.json", spec_root / "P2c_stuck_debate.json"),
        ...
        "archive_note": ("source_packet/P2c_official_archive_note.md", spec_root / "P2c_official_archive_note.md"),
        "scene_v2": ("03_analysis/output/matchups/v2/scene_level_matchups_v2.csv", revision / "03_analysis/output/matchups/v2/scene_level_matchups_v2.csv"),
        "scene_code_v2": ("03_analysis/code/matchups/v2_scene_level_export.py", revision / "03_analysis/code/matchups/v2_scene_level_export.py"),
        "matchup_code_v2": ("03_analysis/code/matchups/v2_matchup_analysis.py", revision / "03_analysis/code/matchups/v2_matchup_analysis.py"),
        "map_code_v2": ("03_analysis/code/matchups/v2_study_map.py", revision / "03_analysis/code/matchups/v2_study_map.py"),
        ...
        "freeze": ("03_analysis/frozen_protocols/matchups_freeze.md", revision / "03_analysis/frozen_protocols/matchups_freeze.md"),
    }
...
def main() -> None:
    ...
    manifest = {
        "analysis": "matchups_v4_postresult_fresh",
        "command": "python v4_build.py --out-dir ../../output/matchups/v4",
