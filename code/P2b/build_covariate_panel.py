#!/usr/bin/env python3
"""P2b — build the same-support weir-year covariate panel.

Constructions are fixed by 03_analysis/frozen_protocols/P2b_freeze.md section 5.
Read-only on all historical trees; writes only under P2B_OUT.
"""
