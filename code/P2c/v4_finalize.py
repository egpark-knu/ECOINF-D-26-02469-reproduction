"""Compare two clean P2c v4 builds, verify, publish reports, and finalize status."""
...
def main() -> None:
    ...
    report_names = ["M3_matchups.md", "M4_spatial.md", "P2c_REPORT.md"]
    ...
    destinations = [
        ...
        revision / "99_admin/reports/P2c_REPORT.md",
    ]
