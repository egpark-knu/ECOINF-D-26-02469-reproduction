"""Render deterministic, submission-facing P2c v4 evidence reports."""
...
"""
    ...
    p2c = f"""# P2c v4 implementation report
...
"""
    ...
    (report_dir / "P2c_REPORT.md").write_text(p2c, encoding="utf-8")
