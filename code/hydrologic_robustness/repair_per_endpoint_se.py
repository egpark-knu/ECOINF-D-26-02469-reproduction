#!/usr/bin/env python3
"""hydrologic robustness — repair per-endpoint clustered SEs and document the submitted-code defect.

DEFECT (found in hydrologic robustness, present in the submitted pipeline):
